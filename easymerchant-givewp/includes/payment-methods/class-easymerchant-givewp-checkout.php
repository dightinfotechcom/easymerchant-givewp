...
if (!class_exists('Easymerchant_Give_WP')) {
    ...
    class Easymerchant_Give_WP
    {
        ...
        public function __construct()
        {
            ...
            add_action('give_easymerchant_cc_form', [$this, 'easymerchant_output_redirect_notice'], 10, 2);

            add_action('give_easymerchant_cc_form', [$this, 'easymerchant_givewp_custom_credit_card_form']);
        }
        ...
        public function easymerchant_output_redirect_notice($formId, $args)
        {
